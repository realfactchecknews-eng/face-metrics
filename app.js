...
//
// Коридоры выставлены по эталонной модели лица MediaPipe (canonical_face_model),
// спроецированной с 50 см — типичное расстояние для селфи. Раньше здесь стояли
// числа из общих канонов красоты, но они описывают ДРУГИЕ замеры: у нас своя
// выборка точек, и по ней даже эталонное лицо проваливалось в «Отклонение» по
// трём из шести строк. Идеал — отклонение до 6% от эталона, приемлемо — до 14%.
var PROP_DEFS = [
  ['lenWidth',  'Длина лица к ширине',   'Face length to width',   [1.26, 1.42], [1.15, 1.52]],
  ['noseFace',  'Длина носа к лицу',     'Nose to face length',    [0.29, 0.33], [0.27, 0.36]],
  ['eyeGap',    'Расстояние между глаз', 'Intercanthal ratio',     [1.38, 1.56], [1.26, 1.67]],
  ['lipsFace',  'Ширина губ к лицу',     'Mouth to face width',    [0.35, 0.39], [0.32, 0.42]],
  ['foreCheek', 'Ширина лба к скулам',   'Forehead to cheekbones', [0.92, 1.03], [0.84, 1.11]],
  ['cheekJaw',  'Ширина скул к челюсти', 'Cheekbones to jaw',      [1.06, 1.19], [0.97, 1.28]],
];
