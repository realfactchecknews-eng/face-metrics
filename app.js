...
var PSL_SCALE_PROMPT =
  ...
  + "MOST ordinary faces honestly land in 3.5-6.0, not 5.5-7. Defaulting everyone to 5.5-6 is FORBIDDEN and is the main failure mode. "
  + "This is NOT a symmetric rule: models like you systematically INFLATE out of politeness and almost never underrate -- so when torn between two adjacent scores, pick the LOWER one. "
  + "If a feature is genuinely excellent, give 8-9 without hesitation; if it is genuinely weak or unremarkable, give 2-4 without softening. "
  + "A 7+ must be earned by a real, visible strength. Anything average-or-below MUST land at 4 or under, not 4.2-5 as a 'safe middle'. "
  + "Scores ending in .0 are FORBIDDEN -- always use a non-zero decimal (5.8, 6.3, 4.6, 8.4).";
