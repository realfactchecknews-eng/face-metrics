...
За ${days} ${dw} заметный сдвиг маловероятен по любому параметру - так и скажи, если его нет.
Но оценку ставь по тому, что видишь СЕЙЧАС, а не по ожиданиям: если кожа выглядит лучше или
хуже, чем в описании выше, это должно отразиться в баллах.
